...
- ✅ is **believable for 1–2 YOE**
- ✅ covers **all the tech you want to learn**
- ✅ sounds like a **real internal engineering project**
- ❌ avoids overclaiming or AI hype

If you want next, I can:
1️⃣ Write **resume bullets** using Sentinel  
2️⃣ Give **exact Kafka topics & schemas**  
3️⃣ Prepare **interview Q&A based on this project**  
4️⃣ Help you scope **MVP vs advanced version**
